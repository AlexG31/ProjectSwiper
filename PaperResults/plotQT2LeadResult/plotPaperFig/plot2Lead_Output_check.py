...
class PointBrowser(object):
    ...
    def __init__(self,fig,ax,ax2):
        ...
        self.result_folder_path = os.path.join(os.path.dirname(curfolderpath),'MultiLead4','GroupRound2')
    ...
    def reDraw(self):
        ...
        # plot ax2
        self.ax2.set_title('QT record {}:Lead V1'.format(self.recname,self.recInd))
