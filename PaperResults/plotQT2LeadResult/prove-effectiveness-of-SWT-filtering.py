...
class FindBadRecord:
    def __init__(self,mean_threshold,std_threshold,FN_threshold,FP_threshold,possible_label_list = None):
    ...
    def display_error_statistics(self):
        ...
        for label in self.possible_label_list:
            ...
            print 'mean = {}, std = {}'.format(np.nanmean(self.statistics_list_for_label[label]['mean']),np.nanmean(self.statistics_list_for_label[label]['std']))
...
if __name__ == '__main__':
    ...
    police_obj = FindBadRecord(10, 13, 20, 20,possible_label_list = possible_label_list)
    # target label

    for RoundInd in xrange(1,10):
