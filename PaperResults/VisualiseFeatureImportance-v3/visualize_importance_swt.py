...
class FeatureVisualizationSwt:
    ...
    def prettify_plot(self,
        ...
        for i in range(2, N_subplot):
            ...
            feature_prettify.prettify(
                    ax_list[(i - 1) / 2, (i - 1) % 2],
                    cDamp[window_limit_left: window_limit_right],
                    pairs,
                    pairs_importance,
                    tarpos - xL - window_limit_left
                    )
    ...
    def plot_dwt_pairs_arrow_transparent(self,
        ...
        for i in range(2, N_subplot):
            ...
            plt.title('SWT Detail Coefficient {}'.format(detail_index))
            # ------------
